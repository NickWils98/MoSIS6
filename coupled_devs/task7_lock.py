...
if __name__ == '__main__':
    ...
    f = open(f'task7_lock_seed{SEED}.txt', 'w')
    ...
    plt.savefig(f"task7_stat4_seed{SEED}.png")
    plt.show()
    ...
    plt.savefig(f"task7_stat7A_seed{SEED}.png")
    plt.show()
    ...
    plt.savefig(f"task7_stat7B_seed{SEED}.png")
    plt.show()
    ...
    plt.savefig(f"task7_stat7C_seed{SEED}.png")
    plt.show()
